...
| <a name="input_devops_agent_version"></a> [devops\_agent\_version](#input\_devops\_agent\_version) | n/a | `string` | `"4.273.0"` | no |
| <a name="input_devops_organization"></a> [devops\_organization](#input\_devops\_organization) | n/a | `string` | `null` | no |
| <a name="input_devops_project_name"></a> [devops\_project\_name](#input\_devops\_project\_name) | n/a | `string` | `null` | no |
| <a name="input_devops_service_connection_id"></a> [devops\_service\_connection\_id](#input\_devops\_service\_connection\_id) | n/a | `string` | `null` | no |
| <a name="input_devops_token_issuer"></a> [devops\_token\_issuer](#input\_devops\_token\_issuer) | n/a | `string` | `null` | no |
| <a name="input_devops_token_subject"></a> [devops\_token\_subject](#input\_devops\_token\_subject) | n/a | `string` | `null` | no |
